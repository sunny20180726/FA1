...
maxValueFeatures0 = ['LOCAL_CUR_SAV_SLOPE','LOCAL_BELONEYR_FF_SLOPE','LOCAL_OVEONEYR_FF_SLOPE','LOCAL_SAV_SLOPE','SAV_SLOPE']
...
numeratorCols = ['LOCAL_SAV_CUR_ALL_BAL','SAV_CUR_ALL_BAL','ASSET_CUR_ALL_BAL','LOCAL_CUR_WITHDRAW_TX_NUM','LOCAL_CUR_WITHDRAW_TX_AMT','COUNTER_NOT_ACCT_TX_NUM',
                 'ATM_ALL_TX_NUM','ATM_ACCT_TX_AMT','ATM_NOT_ACCT_TX_NUM','LOCAL_CUR_MON_AVG_BAL','ASSET_MON_AVG_BAL',"LOCAL_CUR_TRANS_TX_AMT",
                 "LOCAL_CUR_LASTSAV_TX_AMT", "L6M_INDFINA_ALL_TX_AMT", "LOCAL_CUR_WITHDRAW_TX_AMT", "POS_CONSUME_TX_AMT", "LOCAL_FIX_OPEN_ACC_TX_AMT",
                 "ATM_ACCT_TX_AMT", "LOCAL_FIX_WITHDRAW_TX_AMT", "LOCAL_FIX_CLOSE_ACC_TX_AMT", "COUNTER_ACCT_TX_AMT", "TELEBANK_ALL_TX_NUM",
                 "COUNTER_ALL_TX_NUM", "L6M_INDFINA_ALL_TX_NUM", "L6M_INDFINA_ALL_TX_AMT",
                 'threeway_Mean','comp_vce_Mean','mou_opkv_Mean','vceovr_Range','da_Mean','mouiwylisv_Mean','iwylis_vce_Mean','unan_dat_Mean',
...
denominatorCols = ['LOCAL_SAV_MON_AVG_BAL','SAV_MON_AVG_BAL','ASSET_MON_AVG_BAL','TOTAL_WITHDRAW_TX_NUM','TOTAL_WITHDRAW_TX_AMT','TOTAL_COUNTER_TX_NUM',
                   'TOTAL_ACCT_TX_NUM','TOTAL_ACCT_TX_AMT','TOTAL_NOT_ACCT_TX_NUM','LOCAL_CUR_ACCT_NUM','ASSET_CUR_ALL_BAL',"LOCAL_CUR_TRANS_TX_NUM",
                   "LOCAL_CUR_LASTSAV_TX_NUM", "L6M_INDFINA_ALL_TX_NUM", "LOCAL_CUR_WITHDRAW_TX_NUM", "POS_CONSUME_TX_NUM", "LOCAL_FIX_OPEN_ACC_TX_NUM",
                   "ATM_ACCT_TX_NUM", "LOCAL_FIX_WITHDRAW_TX_NUM", "LOCAL_FIX_CLOSE_ACC_TX_NUM", "COUNTER_ACCT_TX_NUM", "TOTAL_TX_NUM", "TOTAL_TX_NUM",
                   "TOTAL_TX_NUM", "ASSET_CUR_ALL_BAL",
                   'totcalls','comp_dat_Mean','mou_cvce_Mean','rev_Range','totcalls','TOTAL_moulisv_Mean','TOTAL_lis_vce_Mean','TOTAL_unan_Mean',
...
modelData.to_csv(path+'/数据/bank attrition/modelData.csv',index = False)